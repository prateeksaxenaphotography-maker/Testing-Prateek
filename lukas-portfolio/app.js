/* ==========================================================================
   LUKAS PORTFOLIO — APPLICATION LOGIC (UPDATED WITH BOOKING & FULL DETAILS)
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function setupFilters() {
    ...
    let html = `<div class="filter-btn ${currentFilter === 'all' ? 'active' : ''}" data-filter="all">All</div>`;
  ...
  function renderProjectDetails(shoot) {
    ...
    if (shoot.description) {
      ...
      // Default storytelling narrative matching Noida photoshoot contexts
  ...
  const DB = "lukas-photostudio-v2", STORE = "shoots";
  let dbP;
  function db() {
    if (dbP) return dbP;
  ...
  function setupUploadForm(shootToEdit = null) {
    ...
    const dropzone = document.getElementById("lukas-dropzone");
